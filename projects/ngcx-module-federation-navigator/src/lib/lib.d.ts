...
export namespace ngcx {
	...
	export namespace module.federation.navigation {
		...
		export namespace item {
			...
			export type Definition = ngcx.navigation.item.IScheme<RemoteComponentEsmOptions | HTML, unknown, StringToken>;

			/** Description of rule the navigation element for publishing in DI. */
			export type ComponentOptions = KeyValue<ComponentType<unknown>, ngcx.navigation.item.Options<unknown>>;
		...
		export namespace navigator {
			...
			export interface Definition {
				...
				readonly navigation: Array<ngcx.navigation.item.Definition<unknown>>;
			}
